...
export default function ProductCard({ product, isFlex, renderDesc }) {
  ...
  return (
    <div
      className={`w-[250px] shadow-md p-2.5 text-black no-underline relative group grid-item min-h-full align-self:stretch ${
        isFlex &&
